        ...
        <div className="mx-auto w-full">
          <Card className="overflow-hidden rounded-2xl border-0 bg-white shadow-[0_4px_24px_rgba(0,0,0,0.04)] ring-1 ring-slate-100">
            ...
            <div className="overflow-x-auto">
              ...
              {/* Empty State */}
              {(!isLoading && visibleStudents.length === 0) || isLoading ? (
                <div className="flex flex-col items-center justify-center py-24">
                  ...
                  <h3 className="text-lg font-bold text-slate-400">
                    {isLoading ? "Loading students..." : "No students to show."}
                  </h3>
                  {!isLoading && (
            ...
            <div className="flex items-center justify-between border-t border-slate-50 bg-white px-6 py-4">
              <span className="text-[13px] font-medium text-slate-500">
                Showing <span className="font-bold text-slate-900">{visibleStudents.length}</span> of <span className="font-bold text-slate-900">{visibleStudents.length}</span> entries
              </span>
